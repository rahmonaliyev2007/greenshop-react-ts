            ...
            <form>
                ...
                <div className='flex gap-3 justify-between items-center'>
                    <label className='w-full my-3 relative'>
                        ...
                        <input className={`w-full my-2 py-2 px-3 rounded-lg border bg-white ${errors.name ? 'border-red-500' : 'border'}`} type="text" value={addressData.name} onChange={(e) => setAddressData({ ...addressData, name: e.target.value })} />
                    ...
                    <label className='w-full my-3 relative'>
                        ...
                        <input className={`w-full my-2 py-2 px-3 rounded-lg border bg-white ${errors.surname ? 'border-red-500' : 'border'}`} type="text" value={addressData.surname} onChange={(e) => setAddressData({ ...addressData, surname: e.target.value })} />
                ...
                <div className='flex gap-3 justify-between items-center'>
                    <label className='w-full my-3 relative'>
                        ...
                        <input className={`w-full my-2 py-2 px-3 rounded-lg border bg-white ${errors.country ? 'border-red-500' : 'border'}`} type="text" value={addressData.country} onChange={(e) => setAddressData({ ...addressData, country: e.target.value })} />
                    ...
                    <label className='w-full my-3 relative'>
                        ...
                        <input className={`w-full my-2 py-2 px-3 rounded-lg border bg-white ${errors.town ? 'border-red-500' : 'border'}`} type="text" value={addressData.town} onChange={(e) => setAddressData({ ...addressData, town: e.target.value })} />
                ...
                <div className='flex gap-3 justify-between items-center'>
                    <label className='w-full my-3 relative'>
                        ...
                        <input className={`w-full my-2 py-2 px-3 rounded-lg border bg-white ${errors.street_address ? 'border-red-500' : 'border'}`} type="text" value={addressData.street_address} onChange={(e) => setAddressData({ ...addressData, street_address: e.target.value })} />
                    ...
                    <label className='w-full my-3'>
                        ...
                        <input className='w-full my-2 py-2 px-3 rounded-lg border bg-white' type="text" value={addressData.extra_address} onChange={(e) => setAddressData({ ...addressData, extra_address: e.target.value })} />
                    </label>
                </div>
                ...
                <div className='flex gap-3 justify-between items-center'>
                    <label className='w-full my-3 relative'>
                        ...
                        <input className={`w-full my-2 py-2 px-3 rounded-lg border bg-white ${errors.state ? 'border-red-500' : 'border'}`} type="text" value={addressData.state} onChange={(e) => setAddressData({ ...addressData, state: e.target.value })} />
                    ...
                    <label className='w-full my-3 relative'>
                        ...
                        <input className={`w-full my-2 py-2 px-3 rounded-lg border bg-white ${errors.zip ? 'border-red-500' : 'border'}`} type="text" value={addressData.zip} onChange={(e) => setAddressData({ ...addressData, zip: e.target.value })} />
                ...
                <div className='flex gap-3 justify-between items-center'>
                    <label className='w-full my-3 relative'>
                        ...
                        <input className={`w-full my-2 py-2 px-3 rounded-lg border bg-white ${errors.email ? 'border-red-500' : 'border'}`} type="email" value={addressData.email} onChange={(e) => setAddressData({ ...addressData, email: e.target.value })} />
                ...
                <label className='w-full my-3'>
                    ...
                    <textarea className='w-full my-2 py-2 px-3 rounded-lg border bg-white' rows={5} value={addressData.textarea} onChange={(e) => setAddressData({ ...addressData, textarea: e.target.value })} />
                </label>
            </form>
        </div>
    );
